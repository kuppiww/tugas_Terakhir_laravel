            ...
            <div class="col-md-4 offset-4 rounded bg-info mt-3 py-3">
                ...
                <form class="mt-3" action="{{ route('update_product', ['product' => $product->id, 'user' => $user->id]) }}" method="POST">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control" name="nama" placeholder="Masukkan nama produk" value="{{ $product->name }}">
                    </div>
                    <div class="mb-1">
                        <label for="exampleFormControlInput1" class="form-label fw-semibold">Berat</label>
                        <input type="number" class="form-control" name="berat" placeholder="Masukkan berat produk" value="{{ $product->weight }}">
                    </div>
                    <div class="mb-1">
                        <label for="exampleFormControlInput1" class="form-label fw-semibold">Harga</label>
                        <input type="number" class="form-control" name="harga" placeholder="Masukkan harga produk" value="{{ $product->price }}">
                    </div>
                    <div class="mb-1">
                        <label for="exampleFormControlInput1" class="form-label fw-semibold">Stok</label>
                        <input type="number" class="form-control" name="stok" placeholder="Masukkan stok produk" value="{{ $product->stock }}">
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="deskripsi" id="exampleFormControlTextarea1" rows="3" placeholder="Tuliskan deskripsi produk yang akan dijual">{{ $product->description }}</textarea>
                    </div>
                    <div class="d-flex">
