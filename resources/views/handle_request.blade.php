            ...
            <div class="col-md-4 offset-4 rounded bg-info mt-3 py-3">
                ...
                <form class="mt-3" action="{{ route('postRequest', ['user' => $user->id]) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="deskripsi" id="exampleFormControlTextarea1" rows="3" placeholder="Tuliskan deskripsi produk yang akan dijual"></textarea>
                    </div>
                    <div class="d-flex">
                        <a href="{{ route('admin_page', ['user' => $user->id]) }}" class="btn btn-warning mx-auto">Kembali</a>
